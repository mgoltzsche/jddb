...
public interface IModelFactory<V extends IEntity<VREF>, VREF extends IEntityReference, P extends IPropertyValue<?,VREF>> extends IPropertyValueFactory<VREF,P> {
