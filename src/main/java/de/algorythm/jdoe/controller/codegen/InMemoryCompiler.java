...
public class InMemoryCompiler {
	...
	public void compile() throws IOException {
		JavaSource source = new JavaSource("de.algorythm.jdoe.generated.DynamicCompilation", DataModelGenerator.sourceCode);
		...
		try {
			...
			try {
				clazz = classLoader.loadClass("de.algorythm.jdoe.generated.DynamicCompilation");
